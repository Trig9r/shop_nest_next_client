...
import {
  CSSObjectWithLabel,
  GroupBase,
  OptionProps as OptionPropsRS,
  StylesConfig
} from 'react-select';

import { OptionProps } from '@/types/common';

export const controllStyles = (defaultStyles: CSSObjectWithLabel, theme: string) => ({
  ...defaultStyles,
  cursor: 'pointer',
...
export const optionStyles = (
  ...
  state: OptionPropsRS<OptionProps, boolean, GroupBase<OptionProps>>,
  theme: string
) => {
...
export const inputStyles: StylesConfig<OptionProps, boolean, GroupBase<OptionProps>> = {
  indicatorSeparator: () => ({
    border: 'none'
  }),
  dropdownIndicator: () => ({
